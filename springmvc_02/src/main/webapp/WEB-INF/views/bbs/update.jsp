...
<script type="text/javascript">
	// 비밀번호가 암호화 되어 있어서 자바스크립트로 할 수 없음 -> 아래 코드 작성
	...
	<form method="post" encType="multipart/form-data" action="/bbs_update_ok">
		<table summary="게시판 수정하기">
			...
			<tbody>
				...
				<tr>
					<th>이름:</th>
					<td><input type="text" name="writer" size="12" value="${bvo.writer }" readonly></td>
				</tr>
				<tr>
					<th>내용:</th>
				...
				<tr>
					...
					<c:choose>
						...
						<c:otherwise>
							<td>
								<input type="file" name="file_name"><b><br>(${bvo.f_name})</b>
