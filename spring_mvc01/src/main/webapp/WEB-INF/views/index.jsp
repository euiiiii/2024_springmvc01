...
<body>
    ...
    <!-- 이미지는 무조건 webapp-resources 안에 넣기 -->
    <h2>이미지 보기</h2>
    <img alt="" src="/resources/images/img01.jpg" style="width: 100px;">
    <img alt="" src="resources/images/img01.jpg" style="width: 100px;">
    <!-- 세 번째 방법 추천: 애플리케이션 컨텍스트 경로가 변경 되어도 이미지 경로를 올바르게 참조 -->
    <img alt="" src='<c:url value="/resources/images/img01.jpg" />' style="width: 100px;">
    <img alt="" src='<c:url value="resources/images/img01.jpg" />' style="width: 100px;">
    <hr>
    ...
    <!-- commons-fileupload, commons-io 라이브러리 등록: pom.xml 
    	 servlet-context.xml에서 파일업로드용 클래스 등록
    ...
    <h2><a href="/emp">동적 쿼리 연습하는 장소 이동</a></h2>
    <h2><a href="/email">이메일 연습하는 장소 이동</a></h2>
