...
// 컨트롤러를 어노테이션하지 않으면 반드시 Controller를 구현(implements)해야 한다.
public class Start1Controller implements Controller{
	
	// 실행하는 메서드
	@Override
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
		// servlet-context.xml에 되돌아 갔다가 ViewResolver에 들어가는 이름
		// (단순하게 말하면 결과를 보여줄 jsp 이름) => 이름만 작성해야함
		
		// 방법1)
		// ModelAndView mv = new ModelAndView();
		// mv.setViewName(view name = 되돌아 갈 jsp이름 = "result1");
