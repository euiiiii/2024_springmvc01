...
public class BoardVO {
	private String idx, writer, title, content, pwd, hit, b_group, b_step, b_lev, regdate, f_name, active, old_f_name; // DB => group, step, lev이 중요!!
	private MultipartFile file_name; // 파일
