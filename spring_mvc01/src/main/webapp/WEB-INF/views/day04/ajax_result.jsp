...
<body>
    ...
    <script type="text/javascript">
    	$("#btn1").click(function(){
    		...
    		$.ajax({
    			...
    			// data: "",		// 서버에 갈 때 가져갈 데이터(파라미터값)
    			// async: true 또는 false // 비동기=(기본,생략,true), 동기=ㄹfalse
    ...
    <script type="text/javascript">
    	$("#btn2").click(function(){
    		...
    		$.ajax({
    			...
    			success: function(data) {
    				let table = "<table>";
    				table += "<thead><tr><th>회사</th><th>차이름</th><th>개수</th></tr></thead>";
    				table += "<tbody>";
	...
	$("#btn4").click(function() {
        ...
        $.ajax({
            url : "/test04", // 서버주소
            method : "post", // 전달방식
            dataType : "xml", // 가져오는 결과 데이터 타입 (글자 가져오기)
